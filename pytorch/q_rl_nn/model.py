...
def initialize_model(b_load_saved_model, input_count, hidden_layer_count, hidden_layer_size, output_count, optimizer, learning_rate, device):
  # Create model
  model = DQN(input_count, hidden_layer_count, hidden_layer_size, output_count).to(device)
